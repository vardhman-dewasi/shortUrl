    ...
    <div className=" px-4 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-2">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p className="text-base leading-relaxed text-white mt-7">Shortened URLs can be used in publications, documents, advertisements, blogs, forums, instant messages, and other locations.</p>

                <ul className="flex items-center space-x-3 mt-9">
                    <li>
                        <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-orange-600 rounded-full w-12 h-12 hover:bg-blue-600 focus:bg-blue-600">
            ...
            <div >
                <p className="text-xl font-bold tracking-widest text-green-600 uppercase">Company</p>
            ...
            <div>
                <p className="text-xl font-bold tracking-widest text-green-600 uppercase">Help</p>
        ...
        {/* div for newsletter */}
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p className="text-xl font-bold tracking-widest text-green-600 uppercase">Subscribe to newsletter</p>
        ...
        <p className="text-sm text-center text-white">© Copyright 2024, All Rights Reserved by vardhman</p>
    </div>
</section>
